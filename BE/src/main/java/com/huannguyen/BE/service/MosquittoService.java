...
//        String data = new String(message.getPayload());
//        System.out.println("Message arrived and saved. Response from: " + 1 + " Message: " + data);
//
//        DataDevice dataDevice = new DataDevice();
//
//        dataDevice.setDevice(deviceRepository.findById(1));
//        dataDevice.setTime(getTimeLocal());
//        dataDevice.setAction(message.equals("HIGH"));
//
//        return dataDevice;
//    }
//
